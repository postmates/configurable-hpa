...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this configurablehpa.Add(mgr) to install this Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by ConfigurableHorizontalPodAutoscaler - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &configurablehpav1beta1.ConfigurableHorizontalPodAutoscaler{},
	})
	if err != nil {
		return err
	}
